...
class LRUKNode {
 public:
  ...
  LRUKNode(size_t k, bool evictable);

  [[nodiscard]] auto GetHistory() const -> size_t;

  [[nodiscard]] auto GetDis(size_t timestamp) const -> size_t;
...
class LRUKReplacer {
 public:
  ...
  LRUKReplacer(const LRUKReplacer &other) = delete;

  LRUKReplacer(LRUKReplacer &&other) = delete;

  LRUKReplacer &operator=(const LRUKReplacer &other) = delete;

  LRUKReplacer &operator=(LRUKReplacer &&other) = delete;
