...
void Initialize() {
  ...
  const auto train_buffer = new BufferPoolManager(350, make_unique<DiskManager>("train.dat"));
  const auto station_buffer = new BufferPoolManager(180, make_unique<DiskManager>("station.dat"));
